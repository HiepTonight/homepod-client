...
const SensorData = ({ homePodId }) => {
  ...
  <div className="grid grid-cols-2 gap-4 justify-center">
    ...
    <div className="bg-gradient-to-r from-[#2a4174] to-[#091a41] flex flex-col justify-center p-4 gap-4 rounded-lg shadow-lg">
        ...
        <div className="flex items-center justify-between">
            <RiWaterPercentLine className="text-3xl"/>
            <h1 className="font-medium text-3xl">{humi} %</h1>
        </div>
    </div>
    <div className="bg-gradient-to-r from-[#2a4174] to-[#091a41] flex flex-col justify-center p-4 gap-4 rounded-lg shadow-lg">
            <p className="font-light text-xl">Temperature</p>
        <div className="flex items-center justify-between">
            <LuWaves className="text-3xl"/>
            <h1 className="font-medium text-3xl">{temp} °C</h1>
        </div>
    </div>
  </div>
  )
