                ...
                <div className='relative'>
                    <div className='flex justify-around gap-1'>
                        <button
                            ...
                            className={`bg-gray-500 text-gray-200 rounded-md p-1 transition-all duration-300 ${editMode[`${sensor}${condition}`] ? 'bg-blue-600 text-white' : 'text-gray-400 bg-gray-700'}`}
                        >
                            <TiEdit />
                        </button>
                        <button
                    ...
                    return (
                        ...
                        >
                            ...
                            <select
                                value={device.action}
                                onChange={(e) =>
                                    handleDeviceChange(sensor, condition, device.id, 'action', e.target.value)
                                }
