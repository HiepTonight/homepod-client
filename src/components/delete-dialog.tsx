...
export function DeleteDialog({ addDevice, homePodId, isEditMode }) {
    ...
    return (
        <Dialog>
            ...
            <DialogContent onClick={(e) => e.stopPropagation()} className='sm:max-w-[450px] bg-[#18191f] overflow-y-auto max-h-[70vh] rounded-lg shadow-lg p-4 transition-all duration-300'>
                <DialogHeader>
