...
import { signIn, getUserInfo, oAuthSignIn } from '@/apis/Auth/AuthService'
...
export function LoginForm({
    ...
    const handleOAuthSignIn = async (provider: 'google' | 'github') => {
        ...
        try {
            ...
            window.location.href = url // Điều hướng đến URL nhận được từ backend
        } catch (error) {
    ...
    return (
        <form className={cn('flex flex-col gap-6', className)} {...props} onSubmit={handleSubmit}>
            ...
            <div className='text-center text-sm'>
                ...
                <a
                    className='font-medium cursor-pointer transition-colors duration-300 hover:text-blue-400'
