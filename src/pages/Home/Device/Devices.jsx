  ...
  return (
    <div className='pb-4 max-w col-span-2 rounded-xl shadow bg-gradient-to-r from-[#1b1c1d] to-[#111b24] p-4 md:p-6'>
          <div className='flex justify-between items-center pb-6'>
            ...
            <div className='flex justify-between items-center'>
                <div className='flex justify-between gap-2'>
                    ...
                    <button onClick={openSensorSettings} className="flex justify-between items-center gap-[3px] text-white bg-gray-600 px-4 py-2 rounded-md">
                      Settings
                      <IoMdSettings/>
                    </button>
                    ...
                    <SensorSettingsModal isVisible={isSensorSettingsVisible} onClose={closeSensorSettings} devices={devices} />
                </div>
            </div>
          </div>
          ...
          <div className='grid md:grid-cols-2 xl:grid-cols-4 gap-4 '>
            {
              devices && devices.map((device)=> <DeviceCard key={device.id} device={device} removeDevice={removeDevice} isEditMode={isEditMode}/> )
            }
          </div>
